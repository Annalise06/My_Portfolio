...
const PortfolioItem = ({ img, title, details }) => {
  ...
  return (
    <div className='portfolio_item'>
        <img src={img} alt="Portfolio-Image" className="portfolio_img" />
        ...
        {modal && (
            ...
            <div className="portfolio_modal-content">
                <img src={Close} alt="Close-modal" className="modal_close" onClick={toggleModal} />
                ...
                <img src={img} alt="Modal-img" className="modal_img" />
            </div>
        </div>
        )}
    </div>
